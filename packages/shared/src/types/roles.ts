 ...
 * Maps string keys to display names for existing components
 */
export const LEGACY_USER_ROLE_DISPLAY_NAMES: Record<string, string> = {
  user: "User",
  admin: "Admin",
...
/**
 * Get badge variant for role display in UI components
 */
