  ...
  if (hasGitHubConnected) {
    return (
      <div className="p-3 bg-green-50 rounded-lg border border-green-200">
        <p className="text-sm text-green-900">✓ GitHub account connected</p>
      </div>
    );
  }
  ...
  return (
    <div className="p-3 bg-blue-50 rounded-lg border border-blue-200">
      ...
      <p className="text-xs text-blue-700 mb-3">
        Authorize access to your GitHub account to create and manage
        repositories. You'll be redirected back automatically.
      </p>
      <button
        onClick={onConnect}
        disabled={isLoading}
